...
class BlogTest extends SeleniumTestController {
    ...
    public function testHomepageShowsRecentPostsInCorrectOrder() {
        ...
        $this->assertElementPresent("//body/div[@class='container']/div/div[@class='post'][1]/h2/a[text()='Another Test Post']");
        $this->assertElementPresent("//body/div[@class='container']/div/div[@class='post'][2]/h2/a[text()='This Is A Test Post']");
    }

    public function testPostLinksFromHomepageAreCorrect() {
        $this->open("/");
        $this->assertElementPresent("//body/div[@class='container']/div/div[@class='post'][1]/h2/a[@href='/2011/09/another-test-post']");
    }
